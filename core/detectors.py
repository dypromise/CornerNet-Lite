...
class CornerNet(Base):
    def __init__(self):
        ...
        super(CornerNet, self).__init__(coco, cornernet,
...
class CornerNet_Squeeze(Base):
    def __init__(self):
        ...
        super(CornerNet_Squeeze, self).__init__(
            coco, cornernet, cornernet_inference, model=model_path)
...
class CornerNet_Saccade(Base):
    def __init__(self):
        ...
        cornernet = load_nnet(sys_cfg, model())
        super(CornerNet_Saccade, self).__init__(coco, cornernet,
                                                cornernet_saccade_inference,
                                                model=model_path)
